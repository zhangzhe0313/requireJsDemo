...
var commconConfigContent = fs.readFileSync("src/static/pc/js/commonconfig.js").toString();
...
// 拼接buildjs内容
var str = "{";
str += '"appDir"' + ":" + '"src/static/pc/js", ';
str += '"baseUrl"' + ":" + '"../../", ';
str += '"dir"' + ":" + '"rjs/dist/", ';

var modules = [];
var excludeArray = ['jquery', 'mscore', 'select2', 'validateUtils'];
// 需要生成的模块：数组
...
str += '"fileExclusionRegExp"' + ":" + '"/^(createBuild|ieBetter|require|commonconfig)\.js$|msbuild\.json/",';
...
fs.writeFile("./rjs/msbuild.json", str, function (err) {
    if (err) {
